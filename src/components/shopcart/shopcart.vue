      ...
      <transition name="fold">
        <div class="shopcart-list" v-show="listShow">
          <div>
            ...
            <scroll ref="listContent" class="list-content" :data="selectFoods" :click="true">
              <ul>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    computed: {
      ...
      listShow() {
        if (!this.totalCount) {
          // this.fold = true; // 在计算属性中直接操作属性会报错
          this._foldTrue(); // 把折叠置为 是
          return false;
        }
        let show = !this.fold;
        // 这时需要手动刷新Scroll
    ...
    .shopcart-list
      ...
      .list-content
        ...
        .food
          ...
          padding: 12px 0
          box-sizing: border-box
          @include border-1px(rgba(7, 17, 27, .02))
          .name
            line-height: 24px
            font-size: 14px
            color: rgb(7, 17, 27)
